    ...
    <div className="space-y-5 py-5">
      ...
      <div className="flex flex-col w-11/12 lg:w-8/12 mx-auto gap-6">
        {filteredData.length === 0 ? (
          <p className="text-center text-gray-700">No brands found matching your search.</p>
        ) : (
          filteredData.map((brand) => (
            <div className="bg-white w-11/12 mx-auto p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 lg:grid grid-cols-7 gap-4 border border-gray-300" key={brand._id}>
