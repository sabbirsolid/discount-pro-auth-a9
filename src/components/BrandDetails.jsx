...
//         />
//         <div>
//           <h2 className="font-bold text-3xl">{singleBrand.brand_name}</h2>
//           <p className=" text-lg">{singleBrand.description}</p>
//           <p className="flex items-center gap-2">
//             {" "}
//             Rating: {singleBrand.rating}{" "}
...
//       </div>
//       {/* coupon cards */}
//       <div className="grid grid-cols-3 w-9/12 mx-auto gap-5 p-10">
//         {coupons.map((coupon) => (
//           <div className="w-4/6 bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
//             <div className="p-4">
//               {/* Coupon Description */}
...
//                 <CopyToClipboard onClick={toast.success('sabbir')}  text={coupon.coupon_code}>
//                   <button  className="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-600">Copy Code</button>
//                 </CopyToClipboard>
//               </div>
//             </div>
//           </div>
